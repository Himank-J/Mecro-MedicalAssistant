        ...
        async with stdio_client(server_params) as (read, write):
            ...
            async with ClientSession(read, write) as session:
                ...
                system_prompt = f"""
                    ...
                    3. Basis patient's preferences, provide relevant doctor suggestions from list of available doctors
                    4. Keep track of patient's previous appointments using memory of previous interactions
                    5. Handle emergency cases and provide priority assistance
                    ...
                    Make sure to keep track of patient input and your output in the memory.
